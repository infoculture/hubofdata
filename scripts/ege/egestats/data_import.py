...
DIRECT_DOWNLOAD_URLPAT = "http://d2f6aadeaff96aaafda4-614b9ac7aa1f2556da9aa7df0eee2346.r98.cf2.rackcdn.com/egestats/data/raw/%s"
PAGE_URL = 'http://ege.edu.ru/ru/main/satistics-ege/'
...
class DataImporter:
    ...
    def register(self, package):
        ...
        resources = [{'name': name, 'format': 'XLS', 'url': DIRECT_DOWNLOAD_URLPAT % filename,
                      'description': u'Данные в формате XLS выгруженные с сайта ЕГЭ (ege.edu.ru)'},
                     {'name': u'Статистика ЕГЭ', 'format': '', 'url': PAGE_URL,
                      'description': u'Страница с описанием на сайте ege.edu.ru'}
        ]
        print name

        the_package = { 'name' : key, 'title' : name,
                           'notes' :  package['name'] + u'\n\nДанные с портала ege.edu.ru.\n\n'.encode('utf8'),
                           'tags' : tags,
                           'state' : 'active',
                           'resources': resources,
                           'author' : 'Ivan Begtin',
