...
DATASETS_FILENAME = 'fsknlist.csv'
BASE_URL = 'http://fedstat.ru'
PAGE_URLPAT = 'http://fedstat.ru/indicator/data.do?id=%s'
DIRECT_DOWNLOAD_URLPAT = "http://db5d6ea0e82f092e072c-37f3681af01a3d9c9cbb80b9eeb1d9f9.r33.cf2.rackcdn.com/data_fskn/%s"
...
class DataImporter:
    ...
    def collect_data(self):
        ...
        f = open('fsknlist.csv', 'w')
        keys = ['uniqid', 'id', 'name', 'filename', 'xlsfilename']
        s = '\t'.join(keys) + '\n'
        f.write(s.encode('utf8'))
        files = os.listdir('data_fskn')
        for filename in files:
            ...
            if ext == '.xml':
                ...
                try:
                    ...
                    continue
                xlsfilename = ''
                if os.path.exists('data_fskn/data_' + id + '.xls'):
    ...
    def register(self, package):
        ...
        try:
            ...
            status = 404
        tags = [u'емисс', u'статистика', u'фскн россии', u'росстат']
