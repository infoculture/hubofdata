...
# coding: utf8
"""
Importer data taken from ESIMO (portal.esimo.ru) to the opendata hub
"""
import ckanclient
import csv
import json
...
DIRECT_DOWNLOAD_URLPAT = "http://d2f6aadeaff96aaafda4-614b9ac7aa1f2556da9aa7df0eee2346.r98.cf2.rackcdn.com/esimo/data/raw/%s"
PAGE_URLPAT = 'http://portal.esimo.ru/dataview/viewresource?resourceId=%s'
RSS_URLPAT = 'http://portal.esimo.ru/dataview/viewrss?resourceId=%s'
...
class DataImporter:
    ...
    def __init__(self):
        ...
        self.started = False
        self.start_key = 'esimo_ru_rndmc_14'
        pass
