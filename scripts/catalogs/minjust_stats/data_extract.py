...
import cookielib
import time
BASE_URL = 'http://minjust.ru'

CATALOG_FILE = 'data/datasets.csv'
LIST_URLS = ['http://minjust.ru/ru/activity/statistics?page=2', 'http://minjust.ru/ru/activity/statistics?page=1', 'http://minjust.ru/ru/activity/statistics']
