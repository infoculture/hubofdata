...
DIRECT_DOWNLOAD_URLPAT = "http://d2f6aadeaff96aaafda4-614b9ac7aa1f2556da9aa7df0eee2346.r98.cf2.rackcdn.com/minjust_stats/data/raw/%s"
...
class DataImporter:
    ...
    def __init__(self):
        ...
        self.started = True
        self.start_key = ''
        self.tags = [u'минюст россии', u'статистика', ]
